        ...
        <div className="footer-container">
            <div className="footer-parent">
                ...
                <div className="colz">
                    ...
                    <div className="foot">
                    <i className="mx-1  fa1 fa fa-envelope  ">
                        <span className='mx-3 span' >mt932747@gmail.com</span>
                    </i>
                    <i className="mx-3 fa1  fa fa-whatsapp">
                        <span className='mx-1 span' > +91-9627347143 </span>
                    </i>
                    <i className="mx-3 fa1  fa fa-phone">
                        <span className='mx-1  span'>   +91-9627347143 </span>
                    </i>
                    </div>
                </div>
